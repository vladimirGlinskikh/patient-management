    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        authServiceDb,
                        Map.of("JWT_SECRET",
                                "370c4ad54b8ba5d9f893bdc608ba2c418c572c3f241f69f192be4886876d647c283a2ac461542f6dda6235a0122c33c280822d9f095c404b61a1e9dccc5c45af"));
    ...
    private FargateService createFargateService(
        ...
        if (db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD",
                    db.getSecret().secretValueFromJson("root").toString());
